...
interface PromisifiedExec {
    (command: string): PromiseWithChild<{
        stdout: string;
        stderr: string;
    }>;
    ...
    (command: string, options: ExecOptions): PromiseWithChild<{
        stdout: string;
        stderr: string;
    }>;
    (command: string, options?: ({
        encoding?: string | null;
    } & ExecOptions) | null): PromiseWithChild<{
 ...
 */
export declare const exec: PromisifiedExec;
export {};
